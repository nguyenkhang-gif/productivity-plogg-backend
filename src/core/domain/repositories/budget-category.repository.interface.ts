...
export interface BudgetCategoryRepository {
  ...
  create(userId: string, data: CreateBudgetCategoryDto): Promise<BudgetCategoryEntity>;
  update(id: string, userId: string, data: UpdateBudgetCategoryDto): Promise<void>;
