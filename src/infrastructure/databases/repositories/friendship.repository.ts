...
import { FriendshipRepository } from 'src/core/domain/repositories/friendship.repository.interface';
import {
...
const USER_LOOKUP = [{ $project: { fullName: 1, username: 1, profilePic: 1 } }];
